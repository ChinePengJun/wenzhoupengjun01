...
服务启动后：
- 官网前端（80）：`http://<你的服务器IP或域名>/`
- 后台前端（3000）：`http://<你的服务器IP或域名>:3000/admin`
- 后台 API（3000）：`http://<你的服务器IP或域名>:3000/api/...`

> 可通过 `FRONTEND_PORT` 和 `ADMIN_PORT` 调整端口。
