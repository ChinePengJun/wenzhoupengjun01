...
import { ArrowLeft, Check, MessageSquare, Share2, ShieldCheck, Truck, Clock, ChevronRight } from "lucide-react";
...
export default function ProductDetail() {
  ...
  const tiers = product.tiers ? JSON.parse(product.tiers) : [];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 mb-32">
          ...
          <div className="space-y-6">
            <motion.div 
              ...
              className="aspect-square rounded-[40px] overflow-hidden bg-yunxi-gray"
            >
              <img 
                src={product.img} 
                alt={product.title}
            ...
            <div className="grid grid-cols-4 gap-4">
              {[1, 2, 3, 4].map(i => (
                <div key={i} className="aspect-square rounded-2xl overflow-hidden bg-yunxi-gray cursor-pointer hover:ring-2 ring-yunxi-red transition-all">
                  <img 
                    src={product.img} 
