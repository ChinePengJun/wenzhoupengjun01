          ...
          <div className="lg:col-span-2">
            <div className="flex items-center gap-3 mb-10">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-xs font-bold tracking-[0.2em] uppercase text-white/40">{t('nav.home') === '首页' ? '温州云浠包装有限公司' : 'Wenzhou Yunxi Packaging Co., Ltd.'}</span>
              </div>
            </div>
            ...
            <ul className="space-y-8">
              <li className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-lg font-bold">+86 123 4567 8900</p>
                </div>
              </li>
              <li className="flex gap-4">
                <div className="w-10 h-10 rounded-lg bg-white/5 flex items-center justify-center shrink-0">
                ...
                <div>
                  ...
                  <p className="text-lg font-bold">sales@cysticker.com</p>
                </div>
              </li>
              <li className="flex gap-4">
                <div className="w-10 h-10 rounded-lg bg-white/5 flex items-center justify-center shrink-0">
                ...
                <div>
                  ...
                  <p className="text-lg font-bold leading-snug">{t('footer.address')}</p>
                </div>
              </li>
            </ul>
          </div>
