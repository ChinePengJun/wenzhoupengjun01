        ...
        <div className="max-w-7xl mx-auto px-6 flex items-center justify-between">
          <Link to="/" className="flex items-center gap-3 group">
            ...
            <div className="flex flex-col">
              ...
              <span className={`text-[10px] font-bold tracking-[0.2em] uppercase ${isScrolled ? "text-yunxi-red" : "text-white/60"}`}>{language === 'zh' ? '温州云浠包装有限公司' : 'Wenzhou Yunxi Packaging Co., Ltd.'}</span>
            </div>
          </Link>
        ...
        {isMenuOpen && (
          ...
          >
            ...
            <div className="mt-auto pt-20 border-t border-white/5">
              ...
              <p className="text-xl font-black mb-2">+86 123 4567 8900</p>
              <p className="text-xl font-black">sales@cysticker.com</p>
            </div>
          </motion.div>
        )}
      </AnimatePresence>
